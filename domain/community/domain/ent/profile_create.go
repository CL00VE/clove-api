...
func (pc *ProfileCreate) AddPostIDs(ids ...int) *ProfileCreate {
...
func (pc *ProfileCreate) AddCommentIDs(ids ...int) *ProfileCreate {
	pc.mutation.AddCommentIDs(ids...)
	return pc
}

// AddComments adds the "comments" edges to the Comment entity.
func (pc *ProfileCreate) AddComments(c ...*Comment) *ProfileCreate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
...
func (pc *ProfileCreate) check() error {
	...
	if _, ok := pc.mutation.Image(); !ok {
		return &ValidationError{Name: "image", err: errors.New(`ent: missing required field "Profile.image"`)}
	}
	return nil
}
