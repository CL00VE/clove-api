...
func (pu *PostUpdate) SetIcon(s string) *PostUpdate {
	pu.mutation.SetIcon(s)
	return pu
}

// SetNillableIcon sets the "icon" field if the given value is not nil.
func (pu *PostUpdate) SetNillableIcon(s *string) *PostUpdate {
	if s != nil {
		pu.SetIcon(*s)
	}
	return pu
...
func (pu *PostUpdate) SetLike(i int) *PostUpdate {
	pu.mutation.ResetLike()
	pu.mutation.SetLike(i)
	return pu
}

// SetNillableLike sets the "like" field if the given value is not nil.
func (pu *PostUpdate) SetNillableLike(i *int) *PostUpdate {
	if i != nil {
		pu.SetLike(*i)
	}
	return pu
...
func (pu *PostUpdate) AddLike(i int) *PostUpdate {
	pu.mutation.AddLike(i)
	return pu
}

// SetProfileID sets the "profileID" field.
func (pu *PostUpdate) SetProfileID(i int) *PostUpdate {
	pu.mutation.SetProfileID(i)
	return pu
}

// SetNillableProfileID sets the "profileID" field if the given value is not nil.
func (pu *PostUpdate) SetNillableProfileID(i *int) *PostUpdate {
	if i != nil {
		pu.SetProfileID(*i)
	}
	return pu
...
func (pu *PostUpdate) check() error {
	if _, ok := pu.mutation.ProfileID(); pu.mutation.ProfileCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Post.profile"`)
	}
	return nil
}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Like(); ok {
		_spec.SetField(post.FieldLike, field.TypeInt, value)
	}
	if value, ok := pu.mutation.AddedLike(); ok {
		_spec.AddField(post.FieldLike, field.TypeInt, value)
	}
...
// SetIcon sets the "icon" field.
func (puo *PostUpdateOne) SetIcon(s string) *PostUpdateOne {
	puo.mutation.SetIcon(s)
	return puo
}

// SetNillableIcon sets the "icon" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableIcon(s *string) *PostUpdateOne {
	if s != nil {
		puo.SetIcon(*s)
	}
	return puo
...
// SetLike sets the "like" field.
func (puo *PostUpdateOne) SetLike(i int) *PostUpdateOne {
	puo.mutation.ResetLike()
	puo.mutation.SetLike(i)
	return puo
}

// SetNillableLike sets the "like" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableLike(i *int) *PostUpdateOne {
	if i != nil {
		puo.SetLike(*i)
	}
	return puo
...
// AddLike adds i to the "like" field.
func (puo *PostUpdateOne) AddLike(i int) *PostUpdateOne {
	puo.mutation.AddLike(i)
	return puo
}

// SetProfileID sets the "profileID" field.
func (puo *PostUpdateOne) SetProfileID(i int) *PostUpdateOne {
	puo.mutation.SetProfileID(i)
	return puo
}

// SetNillableProfileID sets the "profileID" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableProfileID(i *int) *PostUpdateOne {
	if i != nil {
		puo.SetProfileID(*i)
	}
	return puo
...
func (puo *PostUpdateOne) check() error {
	if _, ok := puo.mutation.ProfileID(); puo.mutation.ProfileCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Post.profile"`)
	}
	return nil
}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if value, ok := puo.mutation.Like(); ok {
		_spec.SetField(post.FieldLike, field.TypeInt, value)
	}
	if value, ok := puo.mutation.AddedLike(); ok {
		_spec.AddField(post.FieldLike, field.TypeInt, value)
	}
