...
func (cc *CommentCreate) SetLike(i int) *CommentCreate {
	cc.mutation.SetLike(i)
	return cc
}

// SetNillableLike sets the "like" field if the given value is not nil.
func (cc *CommentCreate) SetNillableLike(i *int) *CommentCreate {
	if i != nil {
		cc.SetLike(*i)
	}
	return cc
...
func (cc *CommentCreate) SetProfileID(i int) *CommentCreate {
	cc.mutation.SetProfileID(i)
	return cc
}
...
func (cc *CommentCreate) SetProfile(p *Profile) *CommentCreate {
	return cc.SetProfileID(p.ID)
}
...
func (cc *CommentCreate) defaults() {
	if _, ok := cc.mutation.Like(); !ok {
		v := comment.DefaultLike
		cc.mutation.SetLike(v)
	}
...
func (cc *CommentCreate) check() error {
	...
	if _, ok := cc.mutation.Like(); !ok {
		return &ValidationError{Name: "like", err: errors.New(`ent: missing required field "Comment.like"`)}
	}
	if _, ok := cc.mutation.PostID(); !ok {
		return &ValidationError{Name: "postID", err: errors.New(`ent: missing required field "Comment.postID"`)}
	}
	if _, ok := cc.mutation.ProfileID(); !ok {
		return &ValidationError{Name: "profileID", err: errors.New(`ent: missing required field "Comment.profileID"`)}
	}
	if _, ok := cc.mutation.CreatedAt(); !ok {
