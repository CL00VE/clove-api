...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case post.FieldID, post.FieldLike, post.FieldProfileID:
			values[i] = new(sql.NullInt64)
		case post.FieldIcon, post.FieldContent:
...
func (po *Post) String() string {
	...
	builder.WriteString(po.Icon)
	builder.WriteString(", ")
	builder.WriteString("content=")
	builder.WriteString(po.Content)
	builder.WriteString(", ")
	builder.WriteString("like=")
	builder.WriteString(fmt.Sprintf("%v", po.Like))
	builder.WriteString(", ")
	builder.WriteString("profileID=")
	builder.WriteString(fmt.Sprintf("%v", po.ProfileID))
	builder.WriteString(", ")
